    ...
    <div id="main" class="main">
    	<div class="main-content">
            ...
            <?php if (is_category()) { ?>
            	<h2 class="title" style="margin-left: 50px; margin-top: 50px;"><?php single_cat_title(); ?></h2>
			<?php } elseif (is_month()) { ?>
                <h2 class="title" style="margin-left: 50px; margin-top: 50px;"><?php the_time('F, Y'); ?></h2>
            <?php } ?>
